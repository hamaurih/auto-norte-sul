...
export const Route = createFileRoute("/_authenticated/admin/enriquecimento-produtos")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Imagens, aplicações veiculares, descrições e códigos com fonte, confiança e aprovação." },
  ] }),
...
function Status({ value }: { value: string }) {
  const labels: any = { queued: "Na fila", processing: "Processando", review: "Revisão", approved: "Aprovado", failed: "Falha", pending: "Pendente", rejected: "Rejeitado" };
